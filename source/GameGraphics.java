...
class GamingPanel extends JPanel {
    ...
    public void drawWaddles(){
        ...
        if (gameMechanics.getDoodle().isShoot()) canvas.drawImage(waddles.getImage(), waddles.getX(),waddles.getY(), this);
    }
    private void drawMonsters(){
        for (Monster i: gameMechanics.getMonsters()) canvas.drawImage(i.getImage(),i.getX(), i.getY(), this);
    }
